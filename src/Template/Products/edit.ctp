...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe900;</i><a href="/erp/pages/home">Homepage</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/erp/products">Products</a><span class="crumb-step">&gt;</span><span>Edit</span></div>
        </div>
        <?= $this->Flash->render() ?>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                          <tr>
                            ...
                            <td>
                                <?= $this->Form->control('category_id', ['label' =>'', 'options' => $categories]);?>
                            </td>
                          </tr>
                          <tr>
